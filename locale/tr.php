...
$t['This page works only with an MP4 File, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder1.wwbn.net/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = 'Bu sayfa sadece bir MP4 Dosyası ile çalışır, eğer başka bir formata sahipseniz veya başka bir formata ihtiyacınız varsa, kendi <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>Kodlayıcınız</a> ya da <a href=\'https://encoder1.wwbn.net/\' class=\'btn btn-warning btn-xs\'>Genel</a>\'i kullanın.';
