...
$t['Audio and Video'] = 'Audio e Vídeos';
...
$t['Only verified users can upload'] = 'Apenas usuários verificados podem fazer carregue de mídia';
...
$t['This page works only with an MP4 File, if you have or need any other format, try to install your own <a href=\'https://github.com/WWBN/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'>encoder</a> or use the <a href=\'https://encoder1.wwbn.net/\' class=\'btn btn-warning btn-xs\'>public</a> one'] = 'Esta página funciona apenas com um arquivo MP4, se você tiver ou precisar de qualquer outro formato, tente instalar seu próprio <a href=\'https://github.com/DanielnetoDotCom/AVideo-Encoder\' class=\'btn btn-warning btn-xs\'> codificador </a> ou use <a href=\'https://encoder1.wwbn.net/\' class=\'btn btn-warning btn-xs\'> public </a> one';
